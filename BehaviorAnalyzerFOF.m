function [Acts, BodyPartsTraces] = BehaviorAnalyzerFOF(PathVideo, FilenameVideo, PathDLC, FilenameDLC, PathOut,StartTime, EndTime, PathPreset, FilenamePreset)
...
ZonesOption.NumBodyPart = [13 13 13 13];
