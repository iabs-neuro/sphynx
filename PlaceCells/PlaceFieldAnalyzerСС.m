function [FieldsIC] = PlaceFieldAnalyzerCC(path, filename, filenameNV, filename_V, start, app, endd, n_objects, field_method)
...
pxl2sm = 9; %pixels in sm (for odor and holes arena), y axes
bin_size_sm = 5; %length of bin in sm
...
S_sigma = 3; %criteria for informative place cell(~95%)
