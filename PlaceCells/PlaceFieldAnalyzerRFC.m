function [FieldsIC] = PlaceFieldAnalyzerRFC(pathWS,filenameWS,pathTR,filenameTR,pathNV,filenameNV,pathPR,filenamePR,plot_opt,PathOut)
...
% traces
file_TR_bad = readtable(sprintf('%s%s', pathTR, filenameTR));
file_TR_bad = table2array(file_TR_bad(2:end,2:end));
