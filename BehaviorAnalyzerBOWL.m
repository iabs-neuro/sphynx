function [Acts, BodyPartsTraces, Point] = BehaviorAnalyzerBOWL(PathVideo, FilenameVideo, PathDLC, FilenameDLC, PathOut, StartTime, EndTime, PathPreset, FilenamePreset)
