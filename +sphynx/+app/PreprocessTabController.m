    ...
    methods (Access = private)
        ...
        function showHelpDialog(obj, topic)
            switch lower(topic)
                case 'perpart'
                    msg = sprintf([ ...
                        'Per-part settings table (Block 3) -- R24:\n' ...
                        '\n' ...
                        'Load preprocessed (button in Block 4, next to Save)\n' ...
                        '  loads a saved <exp>_PreprocessSettings.mat and\n' ...
                        '  overlays its per-part + outlier values onto the\n' ...
                        '  currently loaded DLC. Re-keys by body-part name\n' ...
                        '  so reordered or partly-missing parts still work.\n' ...
                        'Check another (button in Block 1, next to Load)\n' ...
                        '  loads a different DLC csv and reuses the\n' ...
                        '  per-part settings already dialled in, then runs\n' ...
                        '  Compute all.\n' ...
                        '\n' ...
                        '\n' ...
