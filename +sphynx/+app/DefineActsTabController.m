    ...
    methods (Access = private)
        ...
        function buildLeftLibraryColumn(obj)
            ...
            uibutton(tb, 'Text', 'Load Barnes', ...
                'BackgroundColor', semanticColor('action'), ...
                'Tooltip', ['Append Barnes default acts (v3.1, 64 acts): ' ...
                    'nose_at_target/holeN/platform (nose / _realout halo, 0.25s), ' ...
                    'body_at_target/holeN/platform (bodycenter / _realout, 0.25s), ' ...
                    'mouse_inside_target/holeN/platform (3 parts in _real, 2s gate), ' ...
                    'nose_at_any_hole. See docs/Barnes/metrics.md.'], ...
