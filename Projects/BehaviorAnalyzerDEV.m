function [Acts, BodyPartsTraces, Point] = BehaviorAnalyzerDEV(PathVideo, FilenameVideo, PathDLC, FilenameDLC, PathOut, StartTime, EndTime, PathPreset, FilenamePreset)
