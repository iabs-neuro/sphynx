function [Acts, BodyPartsTraces] = BehaviorAnalyzerSavelev(PathVideo, FilenameVideo, PathDLC, FilenameDLC, PathOut,StartTime, EndTime, PathPreset, FilenamePreset)
...
RearsThreshold.AllBodyParts = 190;
RearsThreshold.TailbasePawscm = 2.3;
...
% stripes
%  ZonesOption.NameZone = {'Center' 'WallsAndCornersRealOut' 'Object1RealOut' 'Object2RealOut' 'Object3RealOut'};
%  ZonesOption.NameBodyPart = {'bodycenter' 'bodycenter' 'bodycenter' 'bodycenter' 'bodycenter'};
%  ZonesOption.NameAct = {'CenterArea' 'WallsArea' 'StripeBig' 'StripeMedium' 'StripeSmall'};
%  ZonesOption.NumBodyPart = [find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{1})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{2})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{3})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{4})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{5}))];
%  ZonesOption.NumBodyPart = [13 13 13 13 13];
...
ZonesOption.NameAct = {'CenterArea' 'WallsArea' 'SectorBL1' 'SectorBL2' 'SectorWhite' 'SectorStriped' 'SectorStripedSmall' 'SectorStripedBig'};
ZonesOption.NumBodyPart = [find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{1})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{2})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{3})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{4})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{5})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{6})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{7})) find(strcmp(BodyPartsNames, ZonesOption.NameBodyPart{8}))];
