...
for session = 1:length(session_id)
    ...
    %     this_session_table = array2table(this_session_table_data, 'VariableNames', SuperTable.TrialID(session_idx));
    %     writetable(this_session_table_data, sprintf('%s\\%s_Behavior_sorted.xlsx',PathOut, ExpID), 'Sheet', sprintf('Sheet%d', session));
