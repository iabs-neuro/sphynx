...
mice = { 
    ...
    'J01' 'J05' 'J06' 'J14' 'J19' 'J23' 'J24' 'J57' 'J59' 'J61' ...
    };
...
groups = {
    ...
    'bowl' 'control' 'bowl' 'control' 'bowl' 'control' 'control' 'control' 'control' 'control' ...
    };
...
for file = 1:length(FileNames)
    ...
    load(sprintf('%sBOWL_%s_WorkSpace.mat', PathMat, FileNames{file}), 'Acts', 'BodyPartsTraces', 'Point');
...
SuperTable.Table = sortrows(SuperTable.Table, {'line','group'});
...
for session = 1:length(session_id)
    ...
    % сортировка по группе
    [mice_info_sorted, Idx] = sortrows(mice_info, {'line','group'});
