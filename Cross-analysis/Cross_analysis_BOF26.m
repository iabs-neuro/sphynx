...
PathMat = sprintf('e:\\Projects\\%s\\BehaviorData\\6_Mat\\', ExpID);
PathOut = sprintf('e:\\Projects\\%s\\BehaviorData\\', ExpID);
...
mice = {
    'H02' 'H03' 'H04' 'H06' 'H07' 'H10' 'H11' 'H12' 'H13' 'H14' 'H15' 'H16' 'H17' 'H22' 'H26' 'H27' 'H31' 'H32' 'H39'
    };

groups = {
    'TR' 'TR' 'TR' 'AC' 'AC' 'AC' 'TR' 'TR' 'AC' 'TR' 'AC' 'AC' 'AC' 'TR' 'TR' 'AC' 'TR' 'TR' 'AC'
    };
...
for file = 1:length(FileNames)
    ...
    load(sprintf('%s%s_%s_WorkSpace.mat', PathMat, ExpID, FileNames{file}), 'Acts', 'BodyPartsTraces', 'Point');
