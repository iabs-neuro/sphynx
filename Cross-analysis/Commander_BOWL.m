...
PathVideo = sprintf('e:\\Projects\\%s\\2_Combined\\',ExpID1);
PathDLC = sprintf('e:\\Projects\\%s\\4_DLC\\',ExpID1);
PathPreset = sprintf('e:\\Projects\\%s\\3_Preset\\',ExpID1);

PathOut = sprintf('e:\\Projects\\%s\\5_Behavior\\',ExpID1);
...
for file = 121:length(FileNames)
    
    FilenameVideo = sprintf('BOWL_%s.mp4', FileNames{file});
